...
from miniasr.model.base_las import BaseLAS
from miniasr.module import RNNEncoder, ConformerEncoder
from warprnnt_pytorch import RNNTLoss
from warp_rnnt import RNNTLoss as WrLoss
from miniasr.module.rnnt.model import LAS as RNNT
from miniasr.module.rnnt.search import GreedyDecode, LasDecode
...
class ASR(BaseLAS):
    ...
    def __init__(self, tokenizer, args):
        ...
        self.ctc_loss = nn.CrossEntropyLoss(ignore_index=self.tokenizer.pad_idx)
    ...
    def cal_loss(self, logits, enc_len, feat, feat_len, text, text_len):
        ...
        with torch.backends.cudnn.flags(deterministic=True):
            # for reproducibility
            # print('las', text.shape, logits.transpose(-1, -2)[:, :, :-1].shape)
            ctc_loss = self.ctc_loss(logits.transpose(-1, -2)[:, :, :-1], text)
    ...
    def decode(self, logits, enc_len, decode_type=None):
        ...
        token_list = LasDecode(self.model, logits, enc_len)
